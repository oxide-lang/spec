// ---------------------------------------------------------------------------------------------
// Heavily based off of https://github.com/antlr/grammars-v4/blob/master/csharp/CSharpSharwell/CSharpLexer.g4,
// The lexer is its own module licensed under the Eclipse Public License v1.0. 
// ---------------------------------------------------------------------------------------------
...
// Copyright (c) 2017, Chandler Newman (chandler2newman@hotmail.co.uk), Error22.

lexer grammar OxideLexer;
